    ...
    return (
        <motion.div
            ...
            <motion.h4
                ...
                className='text-center mb-2 text-lg font-Ovo'>Intoduction</motion.h4>
            <motion.h2
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    className='flex-1'>
                    <p className='mb-10 max-w-2xl font-Ovo'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam voluptas, rem placeat beatae voluptatum labore non ad dolores quis optio veritatis! Quos sequi saepe veritatis porro quis voluptate voluptatibus ratione.</p>
