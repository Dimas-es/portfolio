    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <motion.p
                ...
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus, iste. Nihil maiores quod similique magni, qui sit necessitatibus?
            </motion.p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <motion.a
                    ...
                    href="#contact"
                    className="px-10 py-3 border rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent dark:border-white"
                >
